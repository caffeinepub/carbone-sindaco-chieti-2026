...
const WA_PRENOTA = "https://wa.me/393927960983?text=Buongiorno%2C%20vorrei%20prenotare%20la%20mia%20firma%20per%20la%20presentazione%20delle%20liste.";
const WA_CHIAMA = "https://wa.me/393927960983?text=Buongiorno%2C%20vorrei%20contattare%20Alessandro%20Carbone.";
const navLinks = [
...
function SectionDivider() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-1 bg-brand-gold mx-auto mt-3 mb-6 rounded" });
}
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-white font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-border shadow-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16 lg:h-20 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-shrink-0 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-brand-blue text-lg lg:text-2xl leading-tight block", children: "Carbone Sindaco" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-xs font-sans font-medium text-muted-foreground tracking-widest uppercase", children: "Chieti 2026" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "nav",
          {
      ...
      mobileMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:hidden bg-white border-t border-border px-4 py-5 shadow-md", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex flex-col gap-1 mb-5", "aria-label": "Menu mobile", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            "data-ocid": "nav.link",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(PenLine, { className: "w-5 h-5 flex-shrink-0" }),
                " Prenota la firma"
              ]
            }
          )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "pb-32", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-white py-10 lg:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-10 lg:gap-16 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "inline-block text-sm font-sans font-semibold tracking-widest uppercase text-brand-gold bg-brand-gold/10 px-3 py-1.5 rounded mb-4", children: "Raccolta firme · Chieti 2026" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-hero font-display font-bold text-brand-blue mb-4", children: "Una firma può far crescere una scelta civica per Chieti" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-base sm:text-lg font-sans font-medium text-muted-foreground", children: [
              "dal pianto, al",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-brand-blue font-bold tracking-wide", children: "PIANO" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base sm:text-lg text-muted-foreground leading-relaxed mb-4", children: "A differenza dei partiti tradizionali già presenti in Parlamento, le liste civiche nascono dal basso e per legge devono raccogliere le firme dei cittadini per poter partecipare alle elezioni." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base sm:text-lg font-semibold text-brand-blue leading-relaxed mb-7", children: "La tua firma viene prima del voto e rende possibile che la nostra voce, e la tua, siano presenti sulla scheda elettorale di Chieti!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-3 mb-7", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-brand-grey-light rounded-xl p-4 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-brand-blue", children: "Chi può firmare" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Elettori del Comune di Chieti" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-brand-grey-light rounded-xl p-4 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-brand-blue", children: "Non è un voto" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Solo per presentare la lista" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-brand-grey-light rounded-xl p-4 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-brand-blue", children: "Ogni firma conta" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Una firma per lista, sempre" })
            ] })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center lg:justify-end mt-2 lg:mt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-full max-w-[480px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "come-funziona", className: "section-alt py-14 lg:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-section-title font-display font-bold text-brand-blue mb-2", children: "Come funziona" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SectionDivider, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base sm:text-lg text-muted-foreground max-w-xl mx-auto", children: "Tre passi semplici per contribuire a portare una proposta civica sulla scheda" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-[1fr_auto_1fr_auto_1fr] gap-4 md:gap-2 items-stretch", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-white rounded-2xl p-7 shadow-card text-center hover:shadow-card-hover transition-shadow", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-3.5 left-1/2 -translate-x-1/2 bg-brand-gold text-white text-sm font-bold px-4 py-1 rounded-full", children: "01" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-4 mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-10 h-10 text-brand-blue" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-brand-blue text-lg sm:text-xl mb-3", children: "Verifica di essere elettore" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm sm:text-base text-muted-foreground leading-relaxed", children: [
              "Controlla di essere iscritto alle liste elettorali del Comune di Chieti.",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  ...
                  children: "È possibile scaricare il certificato di iscrizione alle liste elettorali ON LINE"
                }
              ),
              "."
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex items-center justify-center px-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-brand-gold/20 rounded-full p-1.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            ArrowRight,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-white rounded-2xl p-7 shadow-card text-center hover:shadow-card-hover transition-shadow", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-3.5 left-1/2 -translate-x-1/2 bg-brand-gold text-white text-sm font-bold px-4 py-1 rounded-full", children: "02" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-4 mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PenLine, { className: "w-10 h-10 text-brand-blue" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-brand-blue text-lg sm:text-xl mb-3", children: "Firma per una lista civica" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm sm:text-base text-muted-foreground leading-relaxed", children: "Apponi la tua firma per permettere la presentazione di una lista alle elezioni." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex items-center justify-center px-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-brand-gold/20 rounded-full p-1.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            ArrowRight,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-white rounded-2xl p-7 shadow-card text-center hover:shadow-card-hover transition-shadow", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-3.5 left-1/2 -translate-x-1/2 bg-brand-gold text-white text-sm font-bold px-4 py-1 rounded-full", children: "03" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-4 mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Vote, { className: "w-10 h-10 text-brand-blue" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-brand-blue text-lg sm:text-xl mb-3", children: "La proposta va sulla scheda" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm sm:text-base text-muted-foreground leading-relaxed", children: "Con la tua firma, aiuti una proposta seria a essere presente alla consultazione." })
          ] })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-14 lg:py-20 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-10 lg:gap-12 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-section-title font-display font-bold text-brand-blue mb-4 leading-tight", children: "Partecipare è il primo modo per rimettere in moto la città" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-1 bg-brand-gold mb-6 rounded" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base sm:text-lg text-muted-foreground leading-relaxed mb-5", children: "la partecipazione civica non è rumore di fondo, è presenza reale, ascolto concreto, responsabilità condivisa, quando i cittadini scelgono di esserci, la città può davvero cambiare direzione" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base sm:text-lg text-muted-foreground leading-relaxed mb-7", children: "Firmare per una lista civica è un gesto semplice ma significativo: significa dire che vuoi che ci sia una scelta in più sulla scheda, una proposta costruita sui fatti, sul metodo e sulla vicinanza ai cittadini." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-full p-2.5 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    PenLine,
                    {
                      className: "w-5 h-5 text-brand-gold",
                      "aria-hidden": "true"
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs sm:text-sm font-semibold text-brand-blue text-center leading-tight", children: "Firma" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ArrowRight,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1.5", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs sm:text-sm font-semibold text-brand-blue text-center leading-tight", children: "Lista sulla scheda" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ArrowRight,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1.5", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs sm:text-sm font-semibold text-brand-blue text-center leading-tight", children: "Voto libero" })
                ] })
              ]
            }
          ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center lg:justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "candidato", className: "section-alt py-14 lg:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-10 lg:gap-12 items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center lg:justify-start", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold tracking-widest uppercase text-brand-gold mb-3", children: "Il Candidato" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-section-title font-display font-bold text-brand-blue mb-2", children: "Alessandro Carbone" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-1 bg-brand-gold mb-4 rounded" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-medium text-muted-foreground mb-5", children: "Candidato Sindaco · Chieti 2026" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base sm:text-lg text-muted-foreground leading-relaxed mb-7", children: "Formazione economica, esperienza in corporate finance e consulenza direzionale, passato amministrativo in consiglio comunale. Alessandro Carbone porta a Chieti un metodo concreto: pianificare, misurare, rendere conto." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-4", children: candidatoCards.map((card) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1 h-6 bg-brand-gold rounded-full mb-3" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-brand-blue text-base mb-2", children: card.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm sm:text-base text-muted-foreground leading-relaxed", children: card.desc })
                ]
              },
              card.id
            );
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "programma", className: "py-14 lg:py-20 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-section-title font-display font-bold text-brand-blue mb-2", children: "Il Programma" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SectionDivider, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base sm:text-lg text-muted-foreground max-w-xl mx-auto", children: "Sei assi concreti per riportare Chieti a essere una città che funziona, che cresce e che tiene insieme i suoi cittadini." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5", children: programmaItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-brand-blue text-base sm:text-lg mb-2", children: item.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm sm:text-base text-muted-foreground mb-4 italic", children: item.desc }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 mt-auto", children: item.points.map((pt) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "li",
                {
                  className: "flex items-center gap-2 text-sm sm:text-base text-foreground",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-4 h-4 text-brand-gold flex-shrink-0" }),
                    pt
                  ]
                },
                pt
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "liste", className: "section-alt py-14 lg:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-section-title font-display font-bold text-brand-blue mb-2", children: "Le quattro liste della coalizione" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SectionDivider, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base sm:text-lg text-muted-foreground max-w-xl mx-auto", children: "Quattro proposte civiche diverse, un unico obiettivo: portare Chieti verso il futuro." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-6", children: liste.map((lista) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "article",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-brand-blue text-lg sm:text-xl leading-tight", children: lista.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm sm:text-base text-muted-foreground mt-1", children: lista.desc })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mb-6", children: lista.keywords.map((kw) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  ...
                  children: [
                    ...
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "w-4 h-4 flex-shrink-0" })
                  ]
                }
              )
            ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-14 lg:py-20 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-section-title font-display font-bold text-brand-blue mb-2 text-center", children: "Dove trovare programma e candidati" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionDivider, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4 mt-6", children: liste.map((lista) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: lista.url,
            target: "_blank",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-brand-blue text-sm sm:text-base group-hover:underline leading-tight", children: lista.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground truncate w-full text-center", children: lista.url.replace("https://", "") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "w-4 h-4 text-brand-gold flex-shrink-0" })
            ]
          },
          lista.id
        )) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "faq", className: "section-alt py-14 lg:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-section-title font-display font-bold text-brand-blue mb-2 flex items-center justify-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              CircleHelp,
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Accordion, { type: "single", collapsible: true, className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            AccordionItem,
            {
              value: "item-1",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "font-sans font-semibold text-brand-blue text-base py-5 hover:no-underline text-left", children: "Firmare significa già votare?" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "text-sm sm:text-base text-muted-foreground pb-5 leading-relaxed", children: "No. Firmare serve solo a presentare una lista alle elezioni. Il voto avviene dopo, il giorno delle elezioni. Sono due atti completamente distinti." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            AccordionItem,
            {
              ...
              className: "bg-white rounded-2xl border border-border px-5 sm:px-6",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "font-sans font-semibold text-brand-blue text-base py-5 hover:no-underline text-left", children: "Chi può firmare?" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "text-sm sm:text-base text-muted-foreground pb-5 leading-relaxed", children: "Può firmare chiunque sia iscritto alle liste elettorali del Comune di Chieti. Se sei residente e hai compiuto 18 anni, puoi partecipare." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            AccordionItem,
            {
              ...
              className: "bg-white rounded-2xl border border-border px-5 sm:px-6",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "font-sans font-semibold text-brand-blue text-base py-5 hover:no-underline text-left", children: "Perché ogni firma conta?" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "text-sm sm:text-base text-muted-foreground pb-5 leading-relaxed", children: "Ogni elettore può sottoscrivere una sola lista. Questo rende ogni firma preziosa e determinante per permettere a una lista civica di essere presente sulla scheda." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            AccordionItem,
            {
              ...
              className: "bg-white rounded-2xl border border-border px-5 sm:px-6",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "font-sans font-semibold text-brand-blue text-base py-5 hover:no-underline text-left", children: "Dove posso firmare?" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionContent, { className: "text-sm sm:text-base text-muted-foreground pb-5 leading-relaxed", children: [
                  "Contatta direttamente Alessandro Carbone su WhatsApp per prenotare un appuntamento comodo per te.",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "a",
                    {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            AccordionItem,
            {
              ...
              className: "bg-white rounded-2xl border border-border px-5 sm:px-6",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "font-sans font-semibold text-brand-blue text-base py-5 hover:no-underline text-left", children: "Posso parlare direttamente con il candidato?" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionContent, { className: "text-sm sm:text-base text-muted-foreground pb-5 leading-relaxed", children: [
                  "Sì. Alessandro Carbone è direttamente raggiungibile su WhatsApp al numero 392 79 60 983.",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "a",
                    {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(WhatsAppIcon, { size: 26 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs sm:text-sm md:text-base font-bold tracking-wide uppercase", children: "LINEA DIRETTA CON ALESSANDRO" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-foreground py-8 pb-24 sm:pb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/70", children: "Coalizione civica Carbone Sindaco · Chieti 2026 · Raccolta firme" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-white/50 mt-1", children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Coalizione civica Carbone Sindaco · Chieti 2026"
      ] })
    ] }) })
  ] });
}
