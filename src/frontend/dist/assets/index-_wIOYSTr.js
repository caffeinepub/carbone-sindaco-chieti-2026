...
const WA_INFO = "https://wa.me/393927960983?text=Buongiorno%2C%20vorrei%20maggiori%20informazioni%20sulla%20raccolta%20firme.";
const navLinks = [
...
const howItWorksSteps = [
  {
    id: "verifica",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-8 h-8 text-brand-blue" }),
    step: "01",
  ...
  {
    id: "firma",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(PenLine, { className: "w-8 h-8 text-brand-blue" }),
    step: "02",
  ...
  {
    id: "scheda",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Vote, { className: "w-8 h-8 text-brand-blue" }),
    step: "03",
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-white font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-border shadow-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-bold text-brand-blue text-lg leading-tight", children: [
          "Carbone Sindaco",
      ...
      mobileMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:hidden bg-white border-t border-border px-4 py-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex flex-col gap-3 mb-4", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            "data-ocid": "nav.link",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-white py-16 lg:py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 lg:gap-16 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "inline-block text-xs font-sans font-semibold tracking-widest uppercase text-brand-gold bg-brand-gold/10 px-3 py-1 rounded mb-5", children: "Raccolta firme · Chieti 2026" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl lg:text-5xl font-bold text-brand-blue leading-tight mb-4", children: "Una firma può far crescere una scelta civica per Chieti" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-base font-sans font-medium text-muted-foreground", children: [
              "dal pianto, al",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-brand-blue font-bold tracking-wide", children: "PIANO" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground leading-relaxed mb-8", children: "Le liste civiche hanno bisogno dei cittadini per essere presenti sulla scheda. Firmare non significa votare: significa rendere possibile una proposta seria, conoscere il programma e partecipare da vicino." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-3 gap-3 mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-brand-grey-light rounded-lg p-3 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-brand-blue", children: "Chi può firmare" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Elettori del Comune di Chieti" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-brand-grey-light rounded-lg p-3 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-brand-blue", children: "Non è un voto" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Solo per presentare la lista" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-brand-grey-light rounded-lg p-3 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-brand-blue", children: "Ogni firma conta" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Una firma per lista, sempre" })
            ] })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center lg:justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-[480px] w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-brand-blue/8 rounded-2xl translate-x-3 translate-y-3 -z-10" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "come-funziona", className: "section-alt py-16 lg:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl lg:text-4xl font-bold text-brand-blue mb-3", children: "Come funziona" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto", children: "Tre passi semplici per contribuire a portare una proposta civica sulla scheda" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6 md:gap-4 relative", children: howItWorksSteps.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "relative bg-white rounded-xl p-6 shadow-card text-center",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-3 left-1/2 -translate-x-1/2 bg-brand-gold text-white text-xs font-bold px-3 py-0.5 rounded-full", children: item.step }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-4 mt-2", children: item.icon }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-brand-blue text-lg mb-2", children: item.title }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 lg:py-20 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl lg:text-4xl font-bold text-brand-blue mb-5 leading-tight", children: "Partecipare è il primo modo per rimettere in moto la città" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground leading-relaxed mb-4", children: "La partecipazione civica non è rumore di fondo. È presenza reale, ascolto concreto, responsabilità condivisa. Quando i cittadini scelgono di esserci, la città può davvero cambiare direzione." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground leading-relaxed mb-6", children: "Firmare per una lista civica è un gesto semplice ma significativo: significa dire che vuoi che ci sia una scelta in più sulla scheda, una proposta costruita sui fatti, sul metodo e sulla vicinanza ai cittadini." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: WA_PRENOTA,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center lg:justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-64 max-w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-brand-gold/10 rounded-2xl translate-x-2.5 translate-y-2.5 -z-10" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "candidato", className: "section-alt py-16 lg:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center lg:justify-start", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-60 max-w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-brand-blue/8 rounded-2xl translate-x-2.5 translate-y-2.5 -z-10" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold tracking-widest uppercase text-brand-gold mb-3", children: "Il Candidato" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl lg:text-4xl font-bold text-brand-blue mb-2", children: "Alessandro Carbone" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-muted-foreground mb-4", children: "Candidato Sindaco · Chieti 2026" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground leading-relaxed mb-7", children: "Formazione economica, esperienza in corporate finance e consulenza direzionale, passato amministrativo in consiglio comunale. Alessandro Carbone porta a Chieti un metodo concreto: pianificare, misurare, rendere conto." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-3", children: candidatoCards.map((card) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "bg-white rounded-lg p-4 shadow-card border border-border",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1 h-6 bg-brand-gold rounded-full mb-2" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-brand-blue text-sm mb-1", children: card.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: card.desc })
              ]
            },
            card.id
          )) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "programma", className: "py-16 lg:py-20 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl lg:text-4xl font-bold text-brand-blue mb-3", children: "Il Programma" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto", children: "Sei assi concreti per riportare Chieti a essere una città che funziona, che cresce e che tiene insieme i suoi cittadini." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-5", children: programmaItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-brand-blue text-base mb-1", children: item.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-3 italic", children: item.desc }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: item.points.map((pt) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "li",
                {
                  className: "flex items-center gap-1.5 text-xs text-foreground",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-3 h-3 text-brand-gold flex-shrink-0" }),
                    pt
                  ]
                },
                pt
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "liste", className: "section-alt py-16 lg:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl lg:text-4xl font-bold text-brand-blue mb-3", children: "Le quattro liste della coalizione" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto", children: "Quattro proposte civiche diverse, un unico obiettivo: portare Chieti verso il futuro." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-6", children: liste.map((lista) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "article",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-brand-blue text-lg", children: lista.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: lista.desc })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 mb-5", children: lista.keywords.map((kw) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-14 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl lg:text-3xl font-bold text-brand-blue mb-8 text-center", children: "Dove trovare programma e candidati" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-4", children: liste.map((lista) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: lista.url,
            target: "_blank",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-brand-blue text-sm group-hover:underline", children: lista.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground break-all", children: lista.url.replace("https://", "") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "w-3.5 h-3.5 text-brand-gold" })
            ]
          },
          lista.id
        )) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "faq", className: "section-alt py-16 lg:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl lg:text-4xl font-bold text-brand-blue mb-3", children: "Domande frequenti" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Accordion, { type: "single", collapsible: true, className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            AccordionItem,
            {
              value: "item-1",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "font-sans font-semibold text-brand-blue text-sm py-4 hover:no-underline", children: "Firmare significa già votare?" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "text-sm text-muted-foreground pb-4 leading-relaxed", children: "No. Firmare serve solo a presentare una lista alle elezioni. Il voto avviene dopo, il giorno delle elezioni. Sono due atti completamente distinti." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            AccordionItem,
            {
              ...
              className: "bg-white rounded-xl border border-border px-5",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "font-sans font-semibold text-brand-blue text-sm py-4 hover:no-underline", children: "Chi può firmare?" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "text-sm text-muted-foreground pb-4 leading-relaxed", children: "Può firmare chiunque sia iscritto alle liste elettorali del Comune di Chieti. Se sei residente e hai compiuto 18 anni, puoi partecipare." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            AccordionItem,
            {
              ...
              className: "bg-white rounded-xl border border-border px-5",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "font-sans font-semibold text-brand-blue text-sm py-4 hover:no-underline", children: "Perché ogni firma conta?" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "text-sm text-muted-foreground pb-4 leading-relaxed", children: "Ogni elettore può sottoscrivere una sola lista. Questo rende ogni firma preziosa e determinante per permettere a una lista civica di essere presente sulla scheda." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            AccordionItem,
            {
              ...
              className: "bg-white rounded-xl border border-border px-5",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "font-sans font-semibold text-brand-blue text-sm py-4 hover:no-underline", children: "Dove posso firmare?" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionContent, { className: "text-sm text-muted-foreground pb-4 leading-relaxed", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            AccordionItem,
            {
              ...
              className: "bg-white rounded-xl border border-border px-5",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "font-sans font-semibold text-brand-blue text-sm py-4 hover:no-underline", children: "Posso parlare direttamente con il candidato?" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionContent, { className: "text-sm text-muted-foreground pb-4 leading-relaxed", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-brand-blue py-16 lg:py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl lg:text-4xl font-bold text-white mb-4 leading-tight", children: "Chieti riparte dalle persone che scelgono di esserci" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-base leading-relaxed mb-6", children: "Una firma è il primo passo per portare sulla scheda una proposta civica seria, vicina alla città e pronta a misurarsi sui risultati." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-white/10 rounded-xl px-5 py-3 mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-5 h-5 text-brand-gold" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold text-xl tracking-widest", children: "392 79 60 983" })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-foreground py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/60", children: "Coalizione civica Carbone Sindaco · Chieti 2026 · Raccolta firme" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-white/40 mt-1", children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        ". Realizzato con ♥ usando",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
